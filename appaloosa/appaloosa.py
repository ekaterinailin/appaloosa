...
def FakeFlaresDist(std, nfake, ampl=(5e-1,5e0), dur=(5e-1,2e1),
    ...
    if scatter == True:
        ...
        ax.set_xlabel(r'log duration (in min)', fontsize=11)
        ax.set_ylabel(r'log amplitude (in rel. flux units)', fontsize=11)
